...
class FlutterWechat {
  ...
  static Future<dynamic> registerWechat(String wxId) async {
    var res = await _channel.invokeMethod('registerWechat', {'wxId': wxId});
    return res;
  }
  ...
  static Future<dynamic> shareWebPage(
    ...
    var res = await _channel.invokeMethod('shareWebPage', params);
    return res;
  }
  ...
  static Future<dynamic> shareText({String text: "", int type: 0}) async {
    ...
    var res = await _channel.invokeMethod('shareText', params);
    return res;
  }
  ...
  static Future<dynamic> shareImage({String imgUrl: "", int type: 0}) async {
    ...
    var res = await _channel.invokeMethod('shareImage', params);
    return res;
  }
  ...
  static Future<dynamic> shareMusic(
    ...
    var res = await _channel.invokeMethod('shareMusic', params);
    return res;
  }
  ...
  static Future<dynamic> shareVideo(
    ...
    var res = await _channel.invokeMethod('shareVideo', params);
    return res;
  }
  ...
  static Future<dynamic> login({
    ...
    var res = await _channel.invokeMethod('login', params);
    return res;
  }
  ...
  static Future<dynamic> pay({
    ...
    var res = await _channel.invokeMethod('pay');
    return res;
  }
}
